"""
Author     : Nitin Singh
Dependency : IntegerArray.txt
Execution  : python progAssign1.py
"""
import math
...
def countInv(input_list, size):
    """
    input_list : list of integers
    size       : length/size of inputList
...
def _sortAndCount(input_list, temp_list, left, right):
    ...
    input_list: list of integers
    temp_list : temp list
    left      : integer, identifies starting index of part of list to be sorted
    right     : integer, identifies ending index of part of list to be sorted
    returns   : the number of inversions in inputList and sorts input_list
...
def countSplitInv(input_list, temp_list, left, mid, right):
    ...
    input_list : list of integers
    temp_list  : temp list
    left       : integer, identifies starting index for 1st list
    mid        : integer, identifies starting index for 2nd list
    right      : integer, identifies ending index for the 2nd list
    returns    : the number of inversions in inputList and sorts input_list
...
TEST_LIST_1 = [2, 5, 6, 1, 3, 9, 7]
TEST_LIST_2 = [1, 3, 5, 2, 4, 6]


if __name__ == "__main__":
    print mergeSort(TEST_LIST_1) # Runs fine
    print mergeSort(TEST_LIST_2) # Runs fine
